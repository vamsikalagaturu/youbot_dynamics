...
int main(int argc, char** argv)
{
  ...
  while (true) {
    ...
    // define unit constraint forces for EE
    alpha_unit_forces.resize(solver_nc);

    alpha_unit_forces.setColumn(
    ...
    alpha_unit_forces.setColumn(
      3, KDL::Twist(KDL::Vector(0.0, 0.0, 0.0), KDL::Vector(0.0, 0.0, 0.0)));
    alpha_unit_forces.setColumn(
      4, KDL::Twist(KDL::Vector(0.0, 0.0, 0.0), KDL::Vector(0.0, 1.0, 0.0)));
    alpha_unit_forces.setColumn(
      5, KDL::Twist(KDL::Vector(0.0, 0.0, 0.0), KDL::Vector(0.0, 0.0, 1.0)));

    // beta - accel energy for EE
    beta_energy.resize(solver_nc);
